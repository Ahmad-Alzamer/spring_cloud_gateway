...
@Component
public class RandomUserHealthIndicator implements ReactiveHealthIndicator {
    private final WebClient webClient;
    private final String url ;

    public RandomUserHealthIndicator(WebClient webClient, @Value("${apis.random-user.base-url}") String url) {
